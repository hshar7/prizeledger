...
// const web3 = new Web3(new Web3.providers.HttpProvider("https://u0c2m7xypz-u0mwr16c64-rpc.us-east-2.kaleido.io"));
...
function deployContract() {
    web3.eth.getTransactionCount(process.env.RINKEBY_ADDRESS).then((txnCount) => {
        ...
        const source = fs.readFileSync(__dirname+'/../truffle/contracts/PrizeLedger.sol');
